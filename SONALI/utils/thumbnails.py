...
from config import FAILED as YOUTUBE_IMG_URL
...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("SONALI/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("SONALI/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "SONALI/assets/play_icons.png"
